  ...
  return (
    <div>
      ...
      <div class="container">
        ...
        <label for="type"><b>Different places</b></label>
        <output type="text" placeholder="International/Local" name="type" required></output>
        ...
        <output type="text" placeholder="Flight/Train/Bus/Trucking" name="mode" required></output>
